...
- Gauge: green ≥ 90 %, yellow ≥ 60 %, red below. Firmware shows strictly the
  last 10 provider calls actually observed between polls (window starts empty
  on boot / counter reset / provider switch, fills from `succ`/`total` deltas).
